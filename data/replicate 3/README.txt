README
In the data folder, all results from the flow cytometry measurements on Friday 13/06/2025 are placed. An overview of all samples with the original file name, plasmid name, promoter name, inducer, inducer concentration and the new file name can be seen. 
