README
In the data folder, all results from the flow cytometry measurements on Tuesday 20/05/2025 are placed. An overview of all samples with the original file name, plasmid name, promoter name, inducer, inducer concentration and the new file name can be seen. 
